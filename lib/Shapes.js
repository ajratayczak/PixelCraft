...
function star(p1, p2){
	...
	let midpointx = parseInt((p1.x + p2.x)/2);
	let midpoint = (midpointx, p1.y);
	...
	if (rem == 1) {
		let in1len = (dx / 3) - (1/3);
		let in1 = new Point(in1len, in1len);
		let in2 = new Point(p2.x-in1len, in1len);
...
console.log(star(new Point(1, 1), new Point(14, 14)));
